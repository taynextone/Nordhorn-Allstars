...
const Maps = {
  nordhorn: {
    ...
    trainers: [
      { id: 'tim', x: 14, y: 10, defeated: false, name: 'Tim',
      ...
      { id: 'lisa', x: 30, y: 14, defeated: false, name: 'Lisa',
      ...
      { id: 'coach', x: 10, y: 22, defeated: false, name: 'Coach Müller',
      ...
      { id: 'mohammed', x: 38, y: 8, defeated: false, name: 'Mohammed',
      ...
      { id: 'erik', x: 22, y: 32, defeated: false, name: 'Erik',
      ...
      { id: 'koenig', x: 44, y: 36, defeated: false, name: 'König',
  ...
  lingen: {
    ...
    trainers: [
      { id: 'klaus', x: 6, y: 7, defeated: false, name: 'Klaus',
      ...
      { id: 'sven', x: 36, y: 9, defeated: false, name: 'Sven',
      ...
      { id: 'rashta', x: 20, y: 34, defeated: false, name: 'Rashta',
      ...
      { id: 'maxim', x: 22, y: 19, defeated: false, name: 'Maxim',
